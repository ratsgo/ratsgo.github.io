...
$$
\begin{align*}
1=&\sum _{ k=1 }^{ K }{ \log { P(Y=k) }  } \\ =&\sum _{ k=1 }^{ K }{ \frac { 1 }{ Z } { e }^{ { \overrightarrow { { { \beta  } }_{ k } }  }^{ T }\overrightarrow { x }  } } \\ =&\frac { 1 }{ Z } \sum _{ k=1 }^{ K }{ { e }^{ { \overrightarrow { { { \beta  } }_{ k } }  }^{ T }\overrightarrow { x }  } } \\ \\ \therefore &Z=\sum _{ k=1 }^{ K }{ { e }^{ { \overrightarrow { { { \beta  } }_{ k } }  }^{ T }\overrightarrow { x }  } } 
\end{align*}
$$

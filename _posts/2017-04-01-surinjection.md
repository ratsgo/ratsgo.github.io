...
위 결과를 해석하면 해가 존재하는 경우도 그렇지 않은 경우도 나온다는 걸 알 수 있습니다. b1-b2+2b3가 0이면 해가 있지만, 0이 아니면 해가 존재하지 않습니다. 바꿔 말하면 임의의 (b1, b2, b3)에 대해 모두 해가 존재해야 전사함수일텐데, 해가 존재하지 않는 경우가 있으니 전사함수가 아니라는 결론에 도달하게 됩니다.

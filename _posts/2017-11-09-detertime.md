...
첫번째 표와 두번째 표를 비교해서 보면 주절의 시간 표현과 관형사절의 시간 표현이 이루는 체계가 사뭇 다른 점을 확인할 수 있습니다. 관형사형 전성어미 `-ㄴ`과 `-ㄹ`를 제거하면, 관형사형 시간 표현은 `-더-(과거)`, `-느-(현재)`, `-∅-(미래)`의 3분 체계인데요. 각각이 어떤 문법적 의미를 지니는지 확실하지 않습니다. 동사와 형용사의 다른 체계를 이루고 있는 점도 주목할 점입니다.
